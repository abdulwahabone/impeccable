(() => {
  ...
  import("./dcx-settings.js?v=8").catch(() => {});
  ...
  const BRAND_PLACEHOLDER_ASSETS = [
    {
      src: "/assets/brand/placeholders/hanazono-primary-mark.png?v=2",
      kind: "logo",
      title: "Primary mark",
    ...
    {
      src: "/assets/brand/placeholders/hanazono-atelier-seal.png?v=2",
      kind: "logo",
      title: "Atelier seal",
    ...
    {
      src: "/assets/brand/placeholders/hanazono-seasonal-moodboard.webp?v=2",
      kind: "moodboard",
    ...
    {
      src: "/assets/brand/placeholders/hanazono-material-reference.webp?v=2",
      kind: "reference",
  ...
  const COMPONENT_CARD_MEDIA = "/assets/components/hanazono-ikebana-card.jpg?v=2";
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards">
            <div class="dcx-component-demo-grid dcx-component-demo-grid--two">
              <article class="dcx-showcase-card dcx-showcase-card--media">
                <img src="${COMPONENT_CARD_MEDIA}" width="800" height="1200" alt="Purple flowers arranged in a black ceramic vase" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
              ...
              <article class="dcx-showcase-card dcx-showcase-card--media dcx-showcase-card--media-close">
                <img src="${COMPONENT_CARD_MEDIA}" width="800" height="1200" alt="Close crop of purple ikebana flowers" loading="lazy" decoding="async">
                <div class="dcx-showcase-card-body">
        ...
        <figure class="dcx-component-example">
          ...
          <div class="dcx-component-canvas dcx-component-canvas--cards dcx-component-canvas--single-card">
            <article class="dcx-showcase-card dcx-showcase-card--horizontal">
              <img src="${COMPONENT_CARD_MEDIA}" width="800" height="1200" alt="Purple ikebana in a dark ceramic vase" loading="lazy" decoding="async">
              <div class="dcx-showcase-card-body">
        ...
        const accessibility = createDocumentSection("Accessibility", `
          <dl class="dcx-defs">
            <div class="dcx-def">
              ...
              <dd>Gold is reserved for display-scale text. Small links, labels, and inline commands use patina-deep or muted ink on light paper.</dd>
            </div>
            <div class="dcx-def">
              <dt>Reading comfort</dt>
              <dd>Body copy on lacquer uses Albert Sans at 1.02rem, a 1.65–1.8 line height, and a 65–75ch reading measure.</dd>
            </div>
            <div class="dcx-def">
              <dt>Keyboard focus</dt>
              <dd>Buttons use a visible patina outline with a 4px offset.</dd>
            </div>
            <div class="dcx-def">
              <dt>Texture &amp; text</dt>
              <dd>Text never sits directly on high-contrast leaf texture. Move texture to an edge or add a lacquer veil behind the copy.</dd>
            </div>
          </dl>
        `);
