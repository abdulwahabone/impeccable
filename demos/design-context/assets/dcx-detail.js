(() => {
  ...
  const DETAIL_META = {
    ...
    typography: {
      ...
      "Interview direction": ["The choices that shaped this typographic voice."],
    },
    components: {
    ...
    iconography: {
      "Library": ["The chosen source, construction, and usage rules."],
    },
    material: {
    ...
    interface: {
      "Decisions per surface": ["How interaction patterns adapt to each experience.", "/assets/product/product-surfaces-foil.png"],
      "The kit": ["The reusable tokens and primitives behind the interface.", "/assets/interface/interface-kit-foil.png"],
      "Components": ["The composed patterns the product can build with.", "/assets/interface/interface-components-foil.png"],
    },
    hooks: {
      "How it runs": [""],
  ...
  const replaceMaterialPagePreviews = (article) => {
    ...
    [
      ["Landing page", "A public-facing page that introduces the experience and guides visitors toward its primary action."],
      ["Portfolio", "A project-led page for presenting selected work, its context, and its outcomes."],
    ].forEach(([label, value]) => {
