...
- **Reaching for it on a native app.** Live drives a browser against your dev server, so it has nothing to attach to on an iOS or Android codebase. Impeccable will not offer it there. See [Design Context](/docs/context).
