      ...
      <div style="padding: 16px; background: color-mix(in oklch, var(--color-accent) 8%, var(--color-paper)); border: 1px solid color-mix(in oklch, var(--color-accent) 20%, var(--color-paper)); border-radius: 8px;">
        <div style="display: flex; align-items: flex-start; gap: 12px;">
          ...
          <div style="flex: 1;">
            ...
            <button style="margin-top: 12px; padding: 8px 16px; background: var(--color-accent); color: var(--ks-on-gold); border: none; border-radius: 6px; font-size: 0.8125rem; font-weight: 500; cursor: pointer;">Retry Connection</button>
          </div>
        </div>
      </div>
